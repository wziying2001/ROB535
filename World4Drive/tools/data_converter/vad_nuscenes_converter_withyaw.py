...
from mmdetection3d.mmdet3d.datasets import NuScenesDataset
from nuscenes.utils.geometry_utils import view_points
from mmdetection3d.mmdet3d.core.bbox.box_np_ops import points_cam2img
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        # print('lidar2ego_translation', cs_record['translation'])
        if sample['next'] == '':
            frame_idx = 0
        else:
            frame_idx += 1
        ...
        if not test:
            ...
            info['gt_ego_his_trajs'] = ego_his_trajs.astype(np.float32) # 这里保留yaw
            info['gt_ego_fut_trajs'] = ego_fut_trajs.astype(np.float32) # 这里保留yaw
            ...
            # print('ego_his_trajs[:, -1]', ego_his_trajs[:, -1])
            # print('ego_fut_trajs[:, -1]', ego_fut_trajs[:, -1])
