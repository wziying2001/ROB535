...
model = AutoModel.from_pretrained('/mnt/nvme0n1p1/yingyan.li/repo/OmniSim/pretrained_models/Emu3-VisionTokenizer', trust_remote_code=True).eval().cuda()
processor = AutoImageProcessor.from_pretrained('/mnt/nvme0n1p1/yingyan.li/repo/OmniSim/pretrained_models/Emu3-VisionTokenizer', trust_remote_code=True)

# TODO: you need to modify the path here
VIDEO_FRAMES_PATH = "/mnt/nvme0n1p1/yingyan.li/repo/OmniSim/reference/Emu3/scripts/misc/test_video"
